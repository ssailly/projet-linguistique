...
public class PngManip {
	...
	public static final String output_path = Paths.get(".").toAbsolutePath().normalize().toString()
			+ "/resources/image_output/image.png";
	public static final String kanji_png = Paths.get(".").toAbsolutePath().normalize().toString()
			+ "/resources/kanji_png/";
